    ...
    <q-page-container>
      <q-page class="column flex-center">
        <c-wizard title="註冊" subtitle="帳號驗證" step="2">
          <q-form @submit="gotoNext" class="q-gutter-y-md q-pa-xl">
            ...
            <c-field stack-label label="輸入驗證碼">
...
import {PasswordResetType} from "src/api/feature";
...
export default class Verification extends ComponentBase {
  ...
  async sendCode() {
    ...
    await this.apis.feature.user.sendVerification({
      ...
      resetType: this.verificationType,
    })
      .then(e => {
  ...
  gotoNext() {
    if (this.verificationCode !== this.form.verification) {
