<template>
  <div class="row">
    ...
    <div class="col-12 col-md-5">
      ...
      <c-select v-model="syncedDay" class="q-px-sm q-mb-md" dense emit-value map-options outlined :options="weekList" />
    </div>
    <div class="col-12 col-md-5">
      <p class="q-px-sm q-ma-none c-content-body">時段</p>
      <c-select v-model="syncedTime" class="q-px-sm q-mb-md" dense emit-value map-options outlined :options="timeList" />
    </div>
  </div>
</template>
...
import FormOrganization from "components/business/FormOrganization2.vue";
