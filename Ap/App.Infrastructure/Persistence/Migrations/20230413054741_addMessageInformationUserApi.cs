...
{
    public partial class addMessageInformationUserApi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "MessageInformationUser",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "Id")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MessageInformationId = table.Column<long>(type: "bigint", maxLength: 20, nullable: false, comment: "MessageInformationId"),
                    UserId = table.Column<long>(type: "bigint", maxLength: 20, nullable: false, comment: "UserId"),
                    LineId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, comment: "LineId"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageInformationUser", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_MessageInformationUser_DateCreate_UserCreate_HandledId",
