        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpperDeptId = table.Column<long>(type: "bigint", maxLength: 255, nullable: false, comment: "UpperDeptId"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "Name"),
                    TitleName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "TitleName"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dept_DateCreate_UserCreate_HandledId",
                table: "Dept",
