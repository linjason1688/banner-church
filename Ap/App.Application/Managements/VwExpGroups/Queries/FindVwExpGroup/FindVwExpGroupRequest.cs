...
namespace App.Application.Managements.VwExpGroups.Queries.FindVwExpGroup
{
    ...
    public class FindVwExpGroupRequest 
        : IRequest<VwExpGroupView>
    {
    ...
    /// 
    /// </summary>
    public class FindVwExpGroupRequestHandler 
        : IRequestHandler<FindVwExpGroupRequest, VwExpGroupView>
    {
        ...
        /// 
        /// </summary>
        public FindVwExpGroupRequestHandler(
            IMapper mapper,
