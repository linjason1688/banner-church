...
{
    /// <summary>
    /// 取得  ModMemberClass 單筆明細
    /// </summary>

    public class FindModMemberClassRequest 
        : IRequest<ModMemberClassView>
    {
    ...
    /// 
    /// </summary>
    public class FindModMemberClassRequestHandler 
        : IRequestHandler<FindModMemberClassRequest, ModMemberClassView>
    {
        ...
        /// 
        /// </summary>
        public FindModMemberClassRequestHandler(
            IMapper mapper,
        ...
        public async Task<ModMemberClassView> Handle(
            FindModMemberClassRequest request,
