...
namespace App.Application.Managements.AspnetRoles.Queries.FindAspnetRole
{
    ...
    public class FindAspnetRoleRequest 
        : IRequest<AspnetRoleView>
    {
    ...
    /// 
    /// </summary>
    public class FindAspnetRoleRequestHandler 
        : IRequestHandler<FindAspnetRoleRequest, AspnetRoleView>
    {
        ...
        /// 
        /// </summary>
        public FindAspnetRoleRequestHandler(
            IMapper mapper,
