...
namespace App.Application.Managements.Newses.ModNewses.Queries.FindModNews
{
    ...
    public class FindModNewsRequest 
        : IRequest<ModNewsView>
    {
    ...
    /// 
    /// </summary>
    public class FindModNewsRequestHandler 
        : IRequestHandler<FindModNewsRequest, ModNewsView>
    {
        ...
        /// 
        /// </summary>
        public FindModNewsRequestHandler(
            IMapper mapper,
