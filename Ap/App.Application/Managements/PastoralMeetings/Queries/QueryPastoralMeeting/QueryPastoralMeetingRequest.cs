...
namespace App.Application.Managements.PastoralMeetings.Queries.QueryPastoralMeeting
{
    ...
    public class QueryPastoralMeetingRequest 
        : PageableQuery, IRequest<Page<PastoralMeetingView>>
    {
    ...
    ///  分頁查詢 PastoralMeeting
    /// </summary>
    public class QueryPastoralMeetingRequestHandler 
        : IRequestHandler<QueryPastoralMeetingRequest, Page<PastoralMeetingView>>
    {
        ...
        /// 
        /// </summary>
        public QueryPastoralMeetingRequestHandler(
            IMapper mapper,
        ...
        /// <returns></returns>
        public async Task<Page<PastoralMeetingView>> Handle(
            QueryPastoralMeetingRequest request,
        ...
        )
        {
            return await this.appDbContext
              ...
              .WhereWhen(Convert.ToInt64(request.PastoralId) != 0, c => c.PastoralId == request.PastoralId)//Pastoral.Id
