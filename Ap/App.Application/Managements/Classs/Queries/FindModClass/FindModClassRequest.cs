...
namespace App.Application.Managements.Classs.ModClasss.Queries.FindModClass
{
    ...
    public class FindModClassRequest 
        : IRequest<ModClassView>
    {
    ...
    /// 
    /// </summary>
    public class FindModClassRequestHandler 
        : IRequestHandler<FindModClassRequest, ModClassView>
    {
        ...
        /// 
        /// </summary>
        public FindModClassRequestHandler(
            IMapper mapper,
