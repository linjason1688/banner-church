...
namespace App.Application.Managements.Teachers.ModTeachers.Queries.FindModTeacher
{
    ...
    public class FindModTeacherRequest 
        : IRequest<ModTeacherView>
    {
    ...
    /// 
    /// </summary>
    public class FindModTeacherRequestHandler 
        : IRequestHandler<FindModTeacherRequest, ModTeacherView>
    {
        ...
        /// 
        /// </summary>
        public FindModTeacherRequestHandler(
            IMapper mapper,
