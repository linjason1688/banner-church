...
namespace App.Application.Managements.Zones.ModZones.Queries.FindModZone
{
    ...
    public class FindModZoneRequest 
        : IRequest<ModZoneView>
    {
    ...
    /// 
    /// </summary>
    public class FindModZoneRequestHandler 
        : IRequestHandler<FindModZoneRequest, ModZoneView>
    {
        ...
        /// 
        /// </summary>
        public FindModZoneRequestHandler(
            IMapper mapper,
