...
namespace App.Application.Managements.UserCourses.Queries.FindUserCourse
{
    ...
    public class FindUserCourseRequest 
        : IRequest<UserCourseView>
    {
    ...
    /// 
    /// </summary>
    public class FindUserCourseRequestHandler 
        : IRequestHandler<FindUserCourseRequest, UserCourseView>
    {
        ...
        /// 
        /// </summary>
        public FindUserCourseRequestHandler(
            IMapper mapper,
