...
namespace App.Application.Managements.Meetings.ModMeetings.Queries.FindModMeeting
{
    ...
    public class FindModMeetingRequest 
        : IRequest<ModMeetingView>
    {
    ...
    /// 
    /// </summary>
    public class FindModMeetingRequestHandler 
        : IRequestHandler<FindModMeetingRequest, ModMeetingView>
    {
        ...
        /// 
        /// </summary>
        public FindModMeetingRequestHandler(
            IMapper mapper,
